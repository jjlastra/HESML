...
for(iexperiment in rawdata_experiments)
{
  ...
  table_Pearson <- matrix(nrow = ncol(rawdata_MedSTS) - 1,
                          ncol = length(rawdata_allDatasets),
                          dimnames = list(colnames(rawdata_MedSTS)[2:ncol(rawdata_MedSTS)],
                                          c("BIOSSES", "CTR", 
                                            "MedSTS_split1",
                                            "MedSTS_split2",
                                            "MedSTS_split3",
  ...
  write.csv(final_data, file = paste(outputDir,"Pvalues_", experimentLabel , ".csv", sep=""))
}
