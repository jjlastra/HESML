...
for (iDataset in 1:length(rawdata_onlyEmbeddings_datasets))
{
	...
	baseFilename <- paste(outputAvgRawFilesDir, sep="", filenames[iDataset])
...
write.csv(averaged_Pearson_results, file = paste(outAvgMetricFilesDir, sep="","table_Pearson_averaged_results.csv"))
write.csv(averaged_Spearman_results, file = paste(outAvgMetricFilesDir, sep="","table_Spearman_averaged_results.csv"))
write.csv(averaged_Harmonic_results, file = paste(outAvgMetricFilesDir, sep="","table_Harmonic_averaged_results.csv"))
...
write.csv(averaged_Pearson_results_rounded, file = paste(outAvgMetricFilesDir, sep="","table_Pearson_averaged_results_rounded.csv"))
write.csv(averaged_Spearman_results_rounded, file = paste(outAvgMetricFilesDir, sep="","table_Spearman_averaged_results_rounded.csv"))
write.csv(averaged_Harmonic_results_rounded, file = paste(outAvgMetricFilesDir, sep="","table_Harmonic_averaged_results_rounded.csv"))

write.csv(averaged_Pearson_results_rounded[,1:10], file = paste(outAvgMetricFilesDir, sep="","table_Pearson_averaged_results_rounded_selection.csv"))
write.csv(averaged_Spearman_results_rounded[, 1:10], file = paste(outAvgMetricFilesDir, sep="","table_Spearman_averaged_results_rounded_selection.csv"))
write.csv(averaged_Harmonic_results_rounded[, 1:10], file = paste(outAvgMetricFilesDir, sep="","table_Harmonic_averaged_results_rounded_selection.csv"))
