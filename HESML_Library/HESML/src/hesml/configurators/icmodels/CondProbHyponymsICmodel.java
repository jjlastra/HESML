...
/**
 * This class implements the CondProbHyponyms IC model introduced in the
 * paper below.
 * 
 ...
 * 
 * In addition, the commercial use of this IC model is protected by
 * the following US patent application:
...
class CondProbHyponymsICmodel extends AbstractCondProbICmodel
{
    /**
    ...
    {
        return (IntrinsicICModelType.CondProbHyponyms.toString());
    }        
}
