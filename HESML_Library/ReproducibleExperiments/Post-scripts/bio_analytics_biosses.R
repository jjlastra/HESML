...
rawdata_results_biosses$abs_sum_errors_best_methods <- rowSums(rawdata_results_biosses[c(63,85,111,113)])
...
rawdata_results_biosses_filtered <- rawdata_results_biosses[, c(1,52,7,18,31,32,63,64,85,86,111,112,113,114,153,154)]
...
colnames(rawdata_results_biosses_filtered)
...
plot(density_LiBlock$x,density_LiBlock$y,type="l", col=rgb(0,0,1), xlim=c(-1,1), main="Probability Density Function (PDF) of the similarity error function in the BIOSSES dataset",xlab="Similarity error = Estimated similarity value - Normalized human score",ylab="Frequency of error")
