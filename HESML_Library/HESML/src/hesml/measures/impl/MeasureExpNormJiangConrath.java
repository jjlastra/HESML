...
/**
 * This class implements an unpublished similarity measure defined
...
class MeasureExpNormJiangConrath extends BaseJiangConrathMeasure
{
    /**
     * Constructor
    ...
    MeasureExpNormJiangConrath(
        ITaxonomy   taxonomy) throws Exception
    {
        super(taxonomy);
        
        // We compute the maximum distance 
    ...
    {
        return (SimilarityMeasureType.ExpNormJiangConrath);
    }
