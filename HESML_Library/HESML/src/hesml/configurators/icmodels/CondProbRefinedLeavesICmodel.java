...
/**
 * This class implements the IC model called CondProbRefLeaves
...
class CondProbRefinedLeavesICmodel extends CondProbLeavesICmodel
{
    /**
    ...
    {
        return (IntrinsicICModelType.CondProbRefLeaves.toString());
    }        
}
