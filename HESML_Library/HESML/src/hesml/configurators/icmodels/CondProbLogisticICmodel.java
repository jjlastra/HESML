...
/**
 * This class implements the CondProbLogistic IC model introduced in the
 * paper below.
 * 
...
class CondProbLogisticICmodel extends AbstractCondProbICmodel
{
    /**
    ...
    /**
     * This function computes the conditional probabilities based on the hyponym set.
     * @param taxonomy
    ...
    {
        String  strICmodel = IntrinsicICModelType.CondProbLogistic.toString()
