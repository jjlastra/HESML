...
/**
 * This class implements an unpublished IC model called CondProbRefLeavesSubsumers
 * that belongs to the family introduced in the paper below.
 ...
 * 
 * In addition, the commercial use of this IC model is partially protected
...
class CondProbRefinedLeavesSubsumers extends AbstractCondProbICmodel
{
    /**
    ...
    public void setTaxonomyData(ITaxonomy taxonomy) throws Exception
    {
        ...
        for (IVertex parent: taxonomy.getVertexes())
        {
            ...
            {
                totalProb += getSanchez2011Factor(child);
            }
    ...
    {
        return (IntrinsicICModelType.CondProbRefLeavesSubsumers.toString());
    }        
}