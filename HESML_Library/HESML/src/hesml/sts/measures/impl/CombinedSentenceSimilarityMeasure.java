...
/**
 * This class implements the general methods for calculating measures scores by combining different measures.
 * It is the abstract base class for all combined sentence similarity measures.
 * @author alicia
 */

abstract class CombinedSentenceSimilarityMeasure implements ICombinedSentenceSimilarityMeasure
{
    // List of measures that conforms the combination
    
    protected final ISentenceSimilarityMeasure[] m_measures;
    ...
    CombinedSentenceSimilarityMeasure(
    ...
    public void clear()
    {
        // Iterate all the measures and invoke their clear functions 
