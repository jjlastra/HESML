...
/**
 * This class implements the reader of 'SingleICmodelExperiment' experiments
 * declared into a Xml file. The class reads the 'MixedICmodelsExperiment'
 * XML node and instances a benchmark.
 * @author j.lastra
 */

class SingleICmodelExperimentReader extends XmlBenchmarkReader
{
    /**
     * Constructor.
