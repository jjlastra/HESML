...
# ------------------------------------------------------------------------
# Table 3: Average speed in concepts per second in the GO ontology
# ------------------------------------------------------------------------
...
# We create the table 3 as reported in the paper [4]

table3 <- matrix(nrow = 3, ncol = 4);

colnames(table3) <- c("Similarity measure", "Measure type", "SML", "HESML");

# We fill the row reporting the evaluation of the Rada measure

table3[1,1] = "Rada";
table3[1,2] = "edge-counting";
table3[1,3] = round(rawdata_Rada_GO[1,2] / mean(rawdata_Rada_GO[2:6,3]), digits = 3)
table3[1,4] = round(rawdata_Rada_GO[1,4] / mean(rawdata_Rada_GO[2:6,5]), digits = 3)

table3[2,1] = "AnsSPLRada";
table3[2,2] = "edge-counting";
table3[2,3] = "---";
table3[2,4] = round(rawdata_AncSPLRada_GO[1,4] / mean(rawdata_AncSPLRada_GO[2:6,5]), digits = 3)

table3[3,1] = "Lin + Seco IC model";
table3[3,2] = "IC-based";
table3[3,3] = round(rawdata_Lin_GO[1,2] / mean(rawdata_Lin_GO[2:6,3]), digits = 3)
table3[3,4] = round(rawdata_Lin_GO[1,4] / mean(rawdata_Lin_GO[2:6,5]), digits = 3)

# ------------------------------------------------------------------------
# Table 4: Average speed in the evaluation of the semantic similarity
...
table4 <- matrix(nrow = 4, ncol = 5);

colnames(table4) <- c("Similarity measure", "Measure type", "UMLS::Sim", "SML", "HESML");
...
table4[1,1] = "Rada";
table4[1,2] = "edge-counting";
table4[1,3] = round(30 / mean(rawdata_Rada_MedSTS[1:5,2]), digits = 3)
table4[1,4] = round(30 / rawdata_Rada_MedSTS[1,3], digits = 3)
table4[1,5] = round(30 / mean(rawdata_Rada_MedSTS[1:5,4]), digits = 3)

table4[2,1] = "AnsSPLRada";
table4[2,2] = "edge-counting";
table4[2,3] = "---";
table4[2,4] = "---";
table4[2,5] = round(30 / mean(rawdata_AncSPLRada_MedSTS[1:5,4]), digits = 3)

table4[3,1] = "Lin + Seco IC model";
table4[3,2] = "IC-based";
table4[3,3] = round(30 / mean(rawdata_Lin_MedSTS[1:5,2]), digits = 3)
table4[3,4] = round(30 / mean(rawdata_Lin_MedSTS[1:5,3]), digits = 3)
table4[3,5] = round(30 / mean(rawdata_Lin_MedSTS[1:5,4]), digits = 3)

table4[4,1] = "Wu-Palmer_fast";
table4[4,2] = "depth-based";
table4[4,3] = round(30 / mean(rawdata_WuPalmer_MedSTS[1:5,2]), digits = 3)
table4[4,4] = "---";
table4[4,5] = round(30 / mean(rawdata_WuPalmer_MedSTS[1:5,4]), digits = 3)

# ------------------------------------------------------------------------
# Table 5: Pearson and Spearman correlantion between base path-based measures
