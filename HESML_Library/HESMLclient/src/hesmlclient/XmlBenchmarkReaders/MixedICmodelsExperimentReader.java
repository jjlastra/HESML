 ...
 * declared into a Xml file. The class reads the 'MixedICmodelsExperiment'
 * XML node and instances a benchmark.
 * @author j.lastra
 */

class MixedICmodelsExperimentReader extends XmlBenchmarkReader
{
    /**
     * Constructor.
        ...
        Element experimentRoot)  throws FileNotFoundException, Exception
    {
        ...
        ITaxonomyInfoConfigurator[] icModels = readMixedICmodels(
        ...
        ISimilarityBenchmark experiment = BenchmarkFactory.getMixedICModelsSimilarityTest(
