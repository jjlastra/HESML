...
/**
 * This class implements the CondProbUniform IC model introduced in the
 * paper below.
 * 
...
class CondProbUniformICmodel extends AbstractCondProbICmodel
{
    /**
    ...
    public void setTaxonomyData(ITaxonomy taxonomy) throws Exception
    {
        ...
        for (IVertex parent: taxonomy.getVertexes())
        {
            ...
            double total = children.getCount();
    ...
    {
        return (IntrinsicICModelType.CondProbUniform.toString());
    }        
}
