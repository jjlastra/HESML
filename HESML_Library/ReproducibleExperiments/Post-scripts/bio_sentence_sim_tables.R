...
experimentSubdirectory = "Preprocessing_stopwords_StringMethods"
strCaption = paste("Table \\label{table:", experimentSubdirectory, "}: Pearson (r), Spearman ($\\rho$) and Harmonic score (h) obtained evaluating different Stop Words configurations for String-based methods.", sep="")

experiments$set(experimentSubdirectory, strCaption)

experimentSubdirectory = "Preprocessing_tokenizers_StringMethods"
strCaption = paste("Table \\label{table:", experimentSubdirectory, "}: Pearson (r), Spearman ($\\rho$) and Harmonic score (h) obtained evaluating different Tokenizer configurations for String-based methods.", sep="")
...
# We define the subdirectory experiment and the caption for showing the results in Latex and HTML format
# and we add to the dictionary all the WBSM measures experiments
...
experimentSubdirectory = "Preprocessing_stopwords_WBSM"
strCaption = paste("Table \\label{table:", experimentSubdirectory, "}: Pearson (r), Spearman ($\\rho$) and Harmonic score (h) obtained evaluating different Stop Words configurations for WBSM methods.", sep="")
